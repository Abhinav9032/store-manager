...
public class ProductEntity {
	...
	public ProductEntity(Long id, float cost, int quantity, int discount, Long vendorId, String productName,
			String description, Long categoryId, String color, String brand, String productImageUrl, String size) {
		this.id = id;
		this.cost = cost;
		this.quantity = quantity;
		this.discount = discount;
	...
	public String toString() {
		return "ProductEntity [id=" + id + ", cost=" + cost + ", quantity=" + quantity + ", discount=" + discount
				+ ", vendorId=" + vendorId + ", productName=" + productName + ", description=" + description
				+ ", categoryId=" + categoryId + ", color=" + color + ", brand=" + brand + ", productImageUrl="
				+ productImageUrl + ", size=" + size + "]";
	}
